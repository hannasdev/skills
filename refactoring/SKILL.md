...
* After a refactor, recommend `testing` to verify preserved behavior.
* If the refactor supports an initiative milestone, recommend `milestone-conformance-review` after validation.
* If the refactor is PR-bound and validation is complete, recommend `pre-pr-adversary-review`.
